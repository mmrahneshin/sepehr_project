...
SECRET_KEY = "django-insecure-lzyd2z)g296op85=y3a+i&07#yrs_--^grm+6$k)f^1rf@$lyq"
...
ROOT_URLCONF = "sepehr_judge.urls"
...
WSGI_APPLICATION = "sepehr_judge.wsgi.application"
